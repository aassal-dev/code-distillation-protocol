...
- **Standardized Output Templates:** v0.2.05 Standardized Output Templates.md (single schema; optional Theory vs. Practice for Blueprint artifacts).
- **Prompts:** v0.2.05 The Codebase Distillation Prompts.md (Director, Surveyor conditional, Atomizer, Librarian; Blueprint/Theory vs. Practice).
