...
**Version:** v0.2.05 (add-on to Knowledge Extraction workflow)
...
In v0.2.05, the Blueprint is the optional high-level input for Phase 0 (Director). It is **add-on**: the core pipeline (Director → Survey → Atomize → Librarian) stays one path; Blueprint is enabled when the user supplies a theory file path in config or context.
