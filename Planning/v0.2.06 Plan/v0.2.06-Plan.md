...
**Placement:** This document can live in the protocol repo under `Planning/v0.2.06 Plan` (or `v0.2.06-Plan.md`). It is currently under `openclaw/_distillation/Planning/` for use alongside extraction artifacts.

---

## 1. Summary of v0.2.05 learnings

- **72 learning targets** were turned into 72 findings, then merged by the Librarian into **14 new patterns** plus **58 merges** into existing patterns (see _Why 72 targets → 14 new patterns_ in `_distillation/WHY_72_TARGETS_14_NEW_PATTERNS.md`).
...
- **Why 72 → 14 patterns:** `_distillation/WHY_72_TARGETS_14_NEW_PATTERNS.md`
