...
- ✅ Use the **single** Standardized Output Template (v0.2.04): frontmatter (id, name, type, abstraction, quality, source_repo, source_path, tags) and sections: Problem, Solution, Code, AI Rule. **When Blueprint was used:** add optional **"Theory vs. Practice"** section to the finding (how textbook theory was adapted in this codebase).
...
- **Template:** v0.2.04 Standardized Output Templates.md (single template; optional Theory vs. Practice for Blueprint runs).
- **Prompts:** v0.2.04 The Codebase Distillation Prompts.md — Atomizer section (focus, fractal levels, filename convention, Theory vs. Practice).
