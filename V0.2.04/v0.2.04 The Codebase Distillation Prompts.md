# The Codebase Distillation Prompts (v0.2.04)

**Focus:** Config-driven, state-aware, batched extraction with optional Director (Phase 0), learning_objectives, and optional Blueprint/Theory vs. Practice. Paths and options come from workflow.yaml; resume uses extraction-state.json.
...
- Use the **single** Standardized Output Template (v0.2.04): YAML frontmatter (id, name, type, abstraction, quality, source_repo, source_path, tags) and sections Problem, Solution, Code, AI Rule.
...
Reference the Standardized Output Templates (v0.2.04) and the pattern index format from distillation/patterns/README.md for the library README structure.
