# Standardized Output Templates (v0.2.0)
...
Use this **one** template for Atomizer output (findings) and Librarian output (library patterns). Order: frontmatter → Problem → Solution → Code → AI Rule (ordered-template-pipeline).
